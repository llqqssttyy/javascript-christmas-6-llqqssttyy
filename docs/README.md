...
ps. 구현된 기능에 대해 간략하게 정리한 문서를 함께 첨부하오니, 예상과 다른 부분이 있다면 말씀해주세요!
...
> 아래 내용은 예외를 발생시키는 조건으로,  
> 그중 한 가지라도 해당하는 경우 에러 메시지 출력 후 입력을 다시 받습니다.
...
>
> 표제 건 관련으로 요약본과 참고 자료를 첨부하오니 확인해 주세요!
